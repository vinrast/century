...
//Connection Settings @0-1D40871F
$CCConnectionSettings = array (
    "Principal" => array(
        "Type" => "MySQL",
        "DBLib" => "MySQL",
        "Database" => "centuryc_pagina",
        "Host" => "localhost",
        "Port" => "",
        "User" => "centuryc_pagina",
        "Password" => "NVSFVBO9UX11IUKTV6",
        "Persistent" => false,
...
//Initialize Common Variables @0-F63838A5
...
$CCSLocales->AddLocale("es-VE", Array("es", "VE", array(1, 0, ""), 2, ",", ".", array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"), array("Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"), array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"), array("Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sáb"), array("D", "L", "M", "M", "J", "V", "S"), array("dd", "/", "mm", "/", "yyyy"), array("dddd", ", ", "dd", " de ", "mmmm", " de ", "yyyy"), array("hh", ":", "nn", " ", "tt"), array("hh", ":", "nn", ":", "ss", " ", "tt"), "a.m.", "p.m.", 0, false, "", "windows-1252", "CP1252"));
$CCSLocales->DefaultLocale = strtolower("es-VE");
$CCSLocales->Init();
$Charset = "";
...
//Principal Connection Class @-BD0DB99C
class clsDBPrincipal extends DB_Adapter
{
    function clsDBPrincipal()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["Principal"]);
        parent::Initialize();
...
//End Principal Connection Class
