<?php
//Include Common Files @1-22C0A2DE
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "inmueble.php");
...
//Class_Initialize Event @2-12A39150
    function clsGridmedia($RelativePath, & $Parent)
    {
        ...
        $this->id_media3 = new clsControl(ccsLabel, "id_media3", "id_media3", ccsText, "", CCGetRequestParam("id_media3", ccsGet, NULL), $this);
        $this->id_media2 = new clsControl(ccsLabel, "id_media2", "id_media2", ccsText, "", CCGetRequestParam("id_media2", ccsGet, NULL), $this);
        $this->id_media1 = new clsControl(ccsLabel, "id_media1", "id_media1", ccsText, "", CCGetRequestParam("id_media1", ccsGet, NULL), $this);
...
//DataSource Variables @2-C1ADEAF7
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2EDCDA13
    function clsmediaDataSource(& $Parent)
    {
        ...
        $this->id_media3 = new clsField("id_media3", ccsText, "");
        
        $this->id_media2 = new clsField("id_media2", ccsText, "");
        
        $this->id_media1 = new clsField("id_media1", ccsText, "");
...
//SetValues Method @2-8B663F5D
    function SetValues()
    {
        $this->id_media->SetDBValue(trim($this->f("id_media")));
        $this->id_media3->SetDBValue($this->f("id_media"));
        $this->id_media2->SetDBValue($this->f("id_media"));
        $this->id_media1->SetDBValue($this->f("id_media"));
    }
//End SetValues Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "inmueble.html";
$BlockToParse = "main";
...
//Include events file @1-5524A6A3
include_once("./inmueble_events.php");
